...
module.exports = (function() {
  ...
  */
  var Sequelize = function(database, username, password, options) {
    ...
    if (this.options.continuationLocalStorageEnabled === true){
      if(!this.options.continuationLocationStorageNamespace){
        this.options.logging('Sequelize NOT using Continuation Local Storage, ' +
            'please provide the \'continuationLocationStorageNamespace\' option ');
        this.options.continuationLocalStorageEnabled = false;
      }
      else {
        if (this.options.logging !== false) {
          this.options.logging('Sequelize using Continuation Local Storage, namespace: ');
        }
      }
